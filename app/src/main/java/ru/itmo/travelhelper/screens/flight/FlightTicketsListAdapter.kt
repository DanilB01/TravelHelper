...
interface FlightTicketsUpdateListInterface {
    fun updateList(filteredItems: MutableList<List<String>>)
}

class FlightTicketsListAdapter(
    var items: List<List<String>>,
    private val listener: FlightTicketsOnItemClickListener)
    : RecyclerView.Adapter<FlightTicketsListAdapter.MyViewHolder>(), FlightTicketsUpdateListInterface {
    ...
    override fun updateList(filteredItems: MutableList<List<String>>) {
