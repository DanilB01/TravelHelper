...
import ru.itmo.domain.repositories.activities.FoodRepositoryImpl
import ru.itmo.travelhelper.databinding.FragmentFoodListBinding
...
class FoodListFragment : Fragment(), EventsListView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter = EventsListPresenter(this, FoodRepositoryImpl()) // или передайте зависимость через DI
        setupRecyclerView()
        setupRatingFilter()
